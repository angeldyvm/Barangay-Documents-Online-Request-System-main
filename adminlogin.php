...
.container{
	background-image: linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)), url(bgun.jpg);
...
<body>
	...
	<img src="img/user.png" width="60" height="60" style="margin-left:0%; padding-bottom: 5px;">
		<h1>Admin Login</h1>

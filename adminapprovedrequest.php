			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="adminapprovedrequest.php">Approved Request</a>
						</li>
					</ul>
				</div>
			...
			<div class="content1">
				...
				<div class="order">
					...
					<td><?php echo $row['requestingfor'];?></td>
  					...
  					<td width='80px'><a class ="edit_btn" onclick="return confirm('Are you sure to done this request?');" href="admindone.php?id=<?php echo $row['id'];?>"><i class="far fa-check-circle"></i></a><br><br><a class="edit_btn2" href="#" onclick="showModal()"><i class="far fa-edit"></i></a></td>
 					</tr>
  					<?php } ?>
					</tbody>
					</table>
...
function confirmAndGoBack(id) {
    var userConfirmed = confirm('Are you sure to done this request?');
...
function saveFormData(id) {
    ...
    // You can use AJAX to send the data to the server and save it in the database
    // Here is a basic example using jQuery for simplicity
    $.ajax({
        type: "POST",
        url: "save_data.php", // Replace with your server-side script
        data: { id: id }, // Pass the ID or other data you want to save

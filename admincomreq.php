			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="admincomreq.php">Completed Request</a>
						</li>
					</ul>
				</div>
			...
			<div class="content1">
				...
				<div class="order">
					...
					<table>
                        ...
                        <td width='50px'>
							<a class="delete_btn" bgcolor='#3660A5' onclick="return confirm('Are you sure to delete this request?');" href="requestdelete2.php?id=<?php echo $row['id'];?>"><i class="far fa-trash-alt"></i></a>

...
CREATE TABLE `request` (
  ...
  `id` int(11) NOT NULL,
  `requestingfor` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `firstname` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `midname` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `deniedby` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL

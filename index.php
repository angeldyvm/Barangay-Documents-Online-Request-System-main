...
.color-box {
	...
	right: 0;
	top: -10;
	background-image: linear-gradient(-45deg, #E25E3E 5%, #FFB000 100%);
...
<body>
 	<div class="container">
		 ...
		 <div class="logo" tabindex="0">
			<img src="img/logoto.png">	
  		    <h3>BARANGAY<Span>171</Span></h3>
  	        </div>   
 			<nav> 
			  <ul id="menuList">
		...
		<div class="row"> 
			<div class="col-1">
				<h2> BARANGAY 171 <br> DOCUMENTS REQUEST </h2>
				
				<h4> </h4>
				<button type="button"><a href="login.php">Request Here</a><img src="img/arrow.png"></button>
			</div>
			<div class="col-2">
				<img src="img/drb1.png" class="vector">
